...
class TermsAndConditionCard extends StatelessWidget {
  const TermsAndConditionCard({
    ...
    required this.termsAndConditionOne,
    required this.termsAndConditionTwo,
    this.termsAndConditionThree,
    required this.url,
    this.onTap,
  });
  ...
  final String planKd;
  final String url;
  final String termsAndConditionOne;
  final String termsAndConditionTwo;
  final String? termsAndConditionThree;
              ...
              planKd == '60 KD'
                  ? Row(
                      ...
                      children: [
                        ...
                        Text(
                          planKd == '60 KD'
                              ? termsAndConditionThree.toString()
                              : '',
                          style: TextStyles.light.copyWith(
                            fontSize: 12.sp,
                            fontFamily: 'Sora',
